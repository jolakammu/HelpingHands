...
public class VolunteerItems {
	...
	private ElecctronicCommunication elecCommu;
	...
	public VolunteerItems(int volunteertemId, String orgName,
			...
			Address address, ElecctronicCommunication elecCommu) {
		super();
	...
	public ElecctronicCommunication getElecCommu() {
		return elecCommu;
	}

	public void setElecCommu(ElecctronicCommunication elecCommu) {
		this.elecCommu = elecCommu;
	}
